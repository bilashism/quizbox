      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="/" className="flex items-center">
          <svg
            ...
            <path
              class="logo-top-curve dark:fill-slate-100"
            ...
            />
            <path
              class="logo-bottom-curve dark:fill-slate-100"
            ...
            />
            <path
              class="logo-tick dark:fill-slate-100"
            ...
            />
            <path
              class="logo-cross dark:fill-slate-100"
